...
function pe_customize_controls_scripts() {
  wp_enqueue_script( 'pe-customize-controls', plugin_dir_url() .  '/assets/js/pe-customize-controls.js', array(), '1.0', true );
}
add_action( 'customize_controls_enqueue_scripts', 'pe_customize_controls_scripts' );

function pe_customize_controls_styles() {
  wp_enqueue_style( 'pe-customize-controls', plugin_dir_url() . '/assets/css/pe-customize-controls.css', array(), '1.0' );
}
